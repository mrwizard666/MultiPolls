...
//            if (ModelState.IsValid)
//            {
//                var email = await UserManager.FindAsync(model.Email, model.Password);
//                if (email != null)
//                {
//                    await SignInAsync(email, model.RememberMe);
//                    return RedirectToLocal(returnUrl);
//                }
//                else
//                {
...
//                var result = await UserManager.CreateAsync(email, model.Password);

//                if (result.Succeeded)
//                {
//                    await SignInAsync(email, isPersistent: false);
//                    return RedirectToAction("Index", "Home");
//                }
//                else
//                {
